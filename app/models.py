...
class Post(db.Model):
	...
	#strategystartDate = db.Column(db.String(140))
	#enddate = db.Column(db.String(140))
	#strategyName =db.Column(db.String(140))
	#strategyChoice = db.Column(db.String(140))
