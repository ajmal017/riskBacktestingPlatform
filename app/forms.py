...
class EditForm(Form):
	...
	brokerID = TextAreaField('brokerID', validators = [Length(min = 0, max =140)])
	mdAddress = TextAreaField('mdAddress', validators = [Length(min = 0, max =140)])
	tdAddress = TextAreaField('tdAddress', validators = [Length(min = 0, max =140)])
	userID = TextAreaField('userID', validators = [Length(min = 0, max =140)])
